        ...
        <aside v-if="visib">
            <form v-for="(value,index) in filters_update">
                ...
                <div class="add_auto_block">
                    ...
                    <input type="text" @input="form.issue_year = $event.target.value; value.issue_year = $event.target.value" class="add_auto" :value="value.issue_year">
                </div>
                <div class="add_auto_block">
                ...
                <div class="add_auto_block">
                    ...
                    <input @input="form.mileage = $event.target.value; value.mileage = $event.target.value" type="text" class="add_auto" :value="value.mileage">
                </div>
                <div class="add_auto_block">
                ...
                <div class="add_auto_block">
                    ...
                    <input @input="form.price = $event.target.value; value.price = $event.target.value" type="text" class="add_auto" :value="value.price">
                </div>
                <div class="add_auto_block">
                ...
                <div class="add_auto_block">
                    ...
                    <input @input="form.seller_phone = $event.target.value; value.seller_phone = $event.target.value" type="text" class="add_auto" :value="value.seller_phone">
                </div>
                <div class="add_auto_block">
