    ...
    <main>
        <form>
            ...
            <div class="add_auto_block">
                ...
                <input type="text" v-model="form.issue_year" class="add_auto">
            </div>
            <div class="add_auto_block">
            ...
            <div class="add_auto_block">
                ...
                <input v-model="form.mileage" type="text" class="add_auto">
            </div>
            <div class="add_auto_block">
            ...
            <div class="add_auto_block">
                ...
                <input v-model="form.price" type="text" class="add_auto">
            </div>
            <div class="add_auto_block">
            ...
            <div class="add_auto_block">
                ...
                <input v-model="form.seller_phone" type="text" class="add_auto">
            </div>
            <div class="add_auto_block">
                <span class="add_auto_text">Выберите фото авто</span>
                <input ref="img" multiple @change="selectFile()" type="file" class="add_auto">
            </div>
            <div class="add_auto_block">
...
<script>
    ...
    export default {
        ...
        methods: {
            selectFile() {
                this.form.img = this.$refs.img.files;
            },
            store() {
